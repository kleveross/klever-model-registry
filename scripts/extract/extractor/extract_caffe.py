...
class CaffeExtractor(BaseExtrctor):
    def _extract_inputs(self):
        ...
        for input_name in self.model.inputs:
            ...
            origin_inputs['dataType'] = blob_data.dtype.name
            origin_inputs['dims'] = list(blob_data.shape)
    ...
    def _extract_outputs(self):
        ...
        for output_name in self.model.outputs:
            ...
            origin_outputs['dataType'] = blob_data.dtype.name
            origin_outputs['dims'] = list(blob_data.shape)
